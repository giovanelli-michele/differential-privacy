...
JNIEXPORT jdouble JNICALL Java_Main_PrivacyBudget(JNIEnv *, jobject) {
    return reporter.PrivacyBudget();
}

JNIEXPORT jint JNICALL Java_Main_Sum(JNIEnv *, jobject) {
    return reporter.Sum();
}

JNIEXPORT jint JNICALL Java_Main_PrivateSum(JNIEnv *, jobject) {
    return GetValue<int>(reporter.PrivateSum(.25).ValueOrDie());
}

JNIEXPORT jdouble JNICALL Java_Main_DefaultEpsilon(JNIEnv *, jobject) {
    return DefaultEpsilon();
}

JNIEXPORT jdouble JNICALL Java_Main_Mean(JNIEnv *, jobject) {
    return reporter.Mean();
}

JNIEXPORT jdouble JNICALL Java_Main_PrivateMean(JNIEnv *, jobject) {
...
JNIEXPORT jint JNICALL Java_Main_CountAbove(JNIEnv *, jobject, jint limit) {
    return (reporter.CountAbove(limit));
}

JNIEXPORT jint JNICALL Java_Main_PrivateCountAbove(JNIEnv *, jobject, jint limit) {
...
JNIEXPORT jint JNICALL Java_Main_Max(JNIEnv *, jobject) {
    return reporter.Max();
}

JNIEXPORT jint JNICALL Java_Main_PrivateMax(JNIEnv *, jobject) {
