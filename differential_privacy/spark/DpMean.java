...
public class DpMean extends UserDefinedAggregateFunction {
     ...
     */
    public DpMean(double low, double up) {
     ...
     * with the default epsilon value.
     */
    public DpMean(double eps, double low, double up) {
        System.out.println("Setting epsilon to " + eps);
        epsilon = eps;
        System.out.println("Setting bounds to [" + low + ", " + up + "]");
        lower = low;
